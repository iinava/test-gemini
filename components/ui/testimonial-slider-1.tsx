...
export const TestimonialSlider = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-[650px] md:min-h-[600px] overflow-hidden bg-black text-white p-8 md:p-12",
        className
      )}
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full px-6">
            ...
            {thumbnailReviews.map((review) => {
              ...
              return (
                <button
                  ...
                  className="overflow-hidden rounded-md w-16 h-20 md:w-20 md:h-24 opacity-40 hover:opacity-100 transition-opacity duration-300 focus:outline-none focus:ring-2 focus:ring-white/20"
          ...
          <div className="relative overflow-hidden pt-4 md:pt-24 min-h-[200px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                ...
                <blockquote className="mt-6 text-2xl md:text-3xl font-medium leading-snug text-white/90">
                  "{activeReview.quote}"
                </blockquote>
              </motion.div>
            </AnimatePresence>
